...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/payroll.jpg"));
        ...
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/New.png")));
        ...
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/schedreport.png")));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/newinvoice.png")));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/EditOpen.png")));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/empreport.png")));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/EXPENSE.PNG")));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/payments.png")));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/empreport.png")));
        ...
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/New.png")));
        ...
        u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/calc.png")));
        ...
        u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/explorer.jpg")));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("onlinepayrollmanagesystem/exit.PNG")));
